#ifndef DMZ_COMMAND_LINE_DOT_H
#define DMZ_COMMAND_LINE_DOT_H
...
namespace dmz {
   ...
   class DMZ_APPLICATION_LINK_SYMBOL CommandLineArgs {
   ...
   class DMZ_APPLICATION_LINK_SYMBOL CommandLine {

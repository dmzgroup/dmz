#ifndef DMZ_FOUNDATION_BASE_64_DOT_H
#define DMZ_FOUNDATION_BASE_64_DOT_H
...
namespace dmz {
   ...
   class DMZ_FOUNDATION_LINK_SYMBOL Base64Encoder {
   ...
   class DMZ_FOUNDATION_LINK_SYMBOL Base64Decoder {
...
#endif //  DMZ_FOUNDATION_BASE_64_DOT_H

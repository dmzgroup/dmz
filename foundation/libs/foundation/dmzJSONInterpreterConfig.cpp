...
\class dmz::JSONInterpreterConfig
\ingroup Foundation
\brief Class converts JSON to a config context tree.
\details The class is used by the JSONParser to process the parsed JSON and
convert it into a config context tree.
\sa dmz::JSONParser \n dmz::Config \n  dmz::ConfigContext

*/

struct dmz::JSONInterpreterConfig::State {
...
*/
dmz::JSONInterpreterConfig::JSONInterpreterConfig (const Config &RootConfig) :
      _state (*(new State (RootConfig))) {;}


//! Destructor.
dmz::JSONInterpreterConfig::~JSONInterpreterConfig () { delete &_state; }

dmz::Boolean
dmz::JSONInterpreterConfig::interpret_null () {
...
dmz::Boolean
dmz::JSONInterpreterConfig::interpret_boolean (const Boolean Value) {
...
dmz::Boolean
dmz::JSONInterpreterConfig::interpret_number (const String &Value) {
...
dmz::Boolean
dmz::JSONInterpreterConfig::interpret_string (const String &Value) {
...
dmz::Boolean
dmz::JSONInterpreterConfig::interpret_start_map () {
...
dmz::Boolean
dmz::JSONInterpreterConfig::interpret_map_key (const String &Name) {
...
dmz::Boolean
dmz::JSONInterpreterConfig::interpret_end_map () {
...
dmz::Boolean
dmz::JSONInterpreterConfig::interpret_start_array () {
...
dmz::Boolean
dmz::JSONInterpreterConfig::interpret_end_array () {
...
dmz::String
dmz::JSONInterpreterConfig::get_error () { return _state.error; }

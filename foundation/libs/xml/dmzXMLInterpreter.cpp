...
\class dmz::XMLInterpreter
\ingroup Foundation
\brief XML interpreter interface.
\details Interface used by dmz::XMLParser to process the parsed XML.
\sa dmz::XMLParser

\fn dmz::Boolean dmz::XMLInterpreter::interpret_start_element (
const String &Name,
...
\fn dmz::Boolean dmz::XMLInterpreter::interpret_end_element (const String &Name)
\brief Indicates the end of an element.
\param[in] Name String containing the name of the closed element.

\fn dmz::Boolean dmz::XMLInterpreter::interpret_character_data (const String &Data)
...
\fn dmz::Boolean dmz::XMLInterpreter::interpret_start_cdata_section ()
\brief Indicates the start of a CDATA section.

\fn dmz::Boolean dmz::XMLInterpreter::interpret_end_cdata_section ()
\brief Indicates the end of a CDATA section.

\fn dmz::String dmz::XMLInterpreter::get_error ()

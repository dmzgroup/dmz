#include "dmzApplicationiPhone.h"
...
static const dmz::String ApplicationName ("dmzApplicationTouch");
...
struct dmz::ApplicationiPhone::State {
   ...
   State (const String &TheName, const String &TheDomain) :
      ...
      cache.add_path (dmz_get_main_bundle_directory ());
   }
};
...
*/
dmz::ApplicationiPhone::ApplicationiPhone (
      const String &Name,
      const String &Domain) :
...
//! Destructor.
dmz::ApplicationiPhone::~ApplicationiPhone () { delete &_state; }
...
*/
void
dmz::ApplicationiPhone::set_quiet (const Boolean Value) { _state.quiet = Value; }
/*!
...
*/
dmz::Boolean
dmz::ApplicationiPhone::is_error () const { return _state.error; }
...
*/
dmz::String
dmz::ApplicationiPhone::get_error () const { return _state.errorMsg; }
...
*/
dmz::RuntimeContext *
dmz::ApplicationiPhone::get_context () { return _state.rt.get_context (); }


//! Gets the root of the config context tree.
void
dmz::ApplicationiPhone::get_global_config (Config &data) { data = _state.global; }


//! Adds config contexts to the root of the config context tree.
void
dmz::ApplicationiPhone::add_global_config (Config &data) {
...
*/
void
dmz::ApplicationiPhone::add_config (const String &Name, Config &data) {
...
*/
dmz::Boolean
dmz::ApplicationiPhone::load_plugins () {
...
*/
dmz::Boolean
dmz::ApplicationiPhone::update_time_slice () {
...
dmz::Boolean
dmz::ApplicationiPhone::unload_plugins () {
...
\sa dmz::ApplicationiPhone::load_session()

*/
dmz::Boolean
dmz::ApplicationiPhone::save_session () {
   ...
   if (DefaultDir) {
      ...
      else if (DefaultDir != dmz_get_main_bundle_directory ()) {

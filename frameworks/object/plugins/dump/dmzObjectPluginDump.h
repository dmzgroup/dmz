#ifndef DMZ_OBJECT_PLUGIN_DUMP_DOT_H
#define DMZ_OBJECT_PLUGIN_DUMP_DOT_H
...
namespace dmz {
   ...
   class ObjectPluginDump :
         public Plugin,
         public ObjectObserverUtil {

      public:
         //! \cond
         ObjectPluginDump (const PluginInfo &Info, Config &local);
         ~ObjectPluginDump ();
      ...
      protected:
         String _attr_name (const Handle AttrHandle);
      ...
      private:
         ObjectPluginDump ();
         ObjectPluginDump (const ObjectPluginDump &);
         ObjectPluginDump &operator= (const ObjectPluginDump &);

   };
};

#endif // DMZ_OBJECT_PLUGIN_DUMP_DOT_H

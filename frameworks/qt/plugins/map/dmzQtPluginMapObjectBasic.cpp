...
#include "dmzQtPluginMapObjectBasic.h"
#include <dmzQpModuleMap.h>
#include <dmzQtUtil.h>
...
dmz::QtPluginMapObjectBasic::QtPluginMapObjectBasic (
...
// Plugin Interface
void
dmz::QtPluginMapObjectBasic::discover_plugin (
   ...
   if (Mode == PluginDiscoverAdd) {
      ...
      if (!_canvasModule) {
         ...
         _canvasModule = QpModuleMap::cast (PluginPtr, _canvasModuleName);
      }
   }
   else if (Mode == PluginDiscoverRemove) {

      if (_canvasModule && (_canvasModule == QpModuleMap::cast (PluginPtr))) {
...
void
dmz::QtPluginMapObjectBasic::create_object (
      const UUID &Identity,
...
void
dmz::QtPluginMapObjectBasic::destroy_object (
      const UUID &Identity,
      const Handle ObjectHandle) {
...
void
dmz::QtPluginMapObjectBasic::update_object_state (
      const UUID &Identity,
      const Handle ObjectHandle,
...
void
dmz::QtPluginMapObjectBasic::update_object_text (
      const UUID &Identity,
      const Handle ObjectHandle,
      const Handle AttributeHandle,
      const String &Value,
...
dmz::Boolean
dmz::QtPluginMapObjectBasic::_create_object (
      const Handle ObjectHandle,
      const ObjectType &Type,
      ModelStruct &ms) {
...
void
dmz::QtPluginMapObjectBasic::_destroy_object (const Handle ObjectHandle) {
...
void
dmz::QtPluginMapObjectBasic::_update_object_state (
      const Handle ObjectHandle,
      const Mask &Value,
      const Mask *PreviousValue) {
...
void
dmz::QtPluginMapObjectBasic::_update_group_state (
...
void
dmz::QtPluginMapObjectBasic::_update_default_group_state (
      StateGroupStruct &group,
      const Mask &Value) {
...
dmz::QtPluginMapObjectBasic::_create_item (
      ObjectStruct &os,
      QGraphicsItem *parent,
...
QGraphicsItem *
dmz::QtPluginMapObjectBasic::_create_image_item (
      ObjectStruct &os,
      QGraphicsItem *parent,
      const Config &Data) {
...
QGraphicsPixmapItem *
dmz::QtPluginMapObjectBasic::_create_pixmap_item (
      ObjectStruct &os,
      QGraphicsItem *parent,
      const Config &Data) {
...
QGraphicsSvgItem *
dmz::QtPluginMapObjectBasic::_create_svg_item (
      ObjectStruct &os,
      QGraphicsItem *parent,
      const Config &Data) {
...
dmz::QtPluginMapObjectBasic::_create_text_item (
      ObjectStruct &os,
      QGraphicsItem *parent,
      const Config &Data) {
...
void
dmz::QtPluginMapObjectBasic::_process_item_text (
      ObjectStruct &os,
...
void
dmz::QtPluginMapObjectBasic::_process_item_switch (
      ObjectStruct &os,
...
void
dmz::QtPluginMapObjectBasic::_process_item_state (
      ObjectStruct &os,
      const Mask &State,
...
dmz::Boolean
dmz::QtPluginMapObjectBasic::_file_request (QGraphicsItem *item, const Config &Data) {
   ...
   if (Resource && item) {
      ...
      if (File) {
         ...
         if (pixmapItem) {
            ...
            _log.info << "Loading pixmap file: " << File << endl;
         ...
         if (svgItem) {
            ...
            if (!renderer) {
               ...
               _log.info << "Loading SVG file: " << File << endl;
...
void
dmz::QtPluginMapObjectBasic::_lookup_object_state (
      const Handle ObjectHandle,
      Mask &objState) {
...
void
dmz::QtPluginMapObjectBasic::_lookup_object_type (
      const Handle ObjectHandle,
      ObjectType &objType) {
...
dmz::QtPluginMapObjectBasic::ModelStruct *
dmz::QtPluginMapObjectBasic::_get_model_struct (const ObjectType &ObjType) {
...
dmz::Boolean
dmz::QtPluginMapObjectBasic::_find_config_from_type (
      Config &local,
      ObjectType &objType) {
...
dmz::QtPluginMapObjectBasic::ModelStruct *
dmz::QtPluginMapObjectBasic::_config_to_model_struct (
      Config &local,
...
dmz::String
dmz::QtPluginMapObjectBasic::_get_object_name (ObjectStruct &os) {
...
void
dmz::QtPluginMapObjectBasic::_init (Config &local) {
...
create_dmzQtPluginMapObjectBasic (
      const dmz::PluginInfo &Info,
      dmz::Config &local,
      dmz::Config &global) {

   return new dmz::QtPluginMapObjectBasic (Info, local);
}

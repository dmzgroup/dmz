...
namespace dmz {
   ...
   class QtPluginMapObjectBasic :
      ...
      private:
         QtPluginMapObjectBasic ();
         QtPluginMapObjectBasic (const QtPluginMapObjectBasic &);
         QtPluginMapObjectBasic &operator= (const QtPluginMapObjectBasic &);
   };
};

#endif // DMZ_QT_PLUGIN_MAP_OBJECT_BASIC_DOT_H

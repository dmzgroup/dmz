#ifndef DMZ_QT_PLUGIN_MAP_ZOOM_DOT_H
#define DMZ_QT_PLUGIN_MAP_ZOOM_DOT_H
...
#include "ui_dmzQtPluginMapZoomPan.h"
...
namespace dmz {
   ...
   class QtPluginMapZoomPan :
      ...
      public:
         QtPluginMapZoomPan (const PluginInfo &Info, Config &local);
         ~QtPluginMapZoomPan ();
      ...
      private:
         QtPluginMapZoomPan ();
         QtPluginMapZoomPan (const QtPluginMapZoomPan &);
         QtPluginMapZoomPan &operator= (const QtPluginMapZoomPan &);
   };
};

#endif // DMZ_QT_PLUGIN_MAP_ZOOM_DOT_H

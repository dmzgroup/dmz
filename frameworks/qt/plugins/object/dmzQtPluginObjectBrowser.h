#ifndef DMZ_QT_PLUGIN_OBJECT_BROWSER_DOT_H
#define DMZ_QT_PLUGIN_OBJECT_BROWSER_DOT_H
...
namespace dmz {
   ...
   class QtPluginObjectBrowser :
         public Plugin,
         public MessageObserver,
         public ObjectObserverUtil {

      public:
         QtPluginObjectBrowser (const PluginInfo &Info, Config &local);
         ~QtPluginObjectBrowser ();
      ...
      private:
         QtPluginObjectBrowser ();
         QtPluginObjectBrowser (const QtPluginObjectBrowser &);
         QtPluginObjectBrowser &operator= (const QtPluginObjectBrowser &);

   };
};

#endif // DMZ_QT_PLUGIN_OBJECT_BROWSER_DOT_H

...
*/
   template <class T> class HashTable$(type)Template {
      ...
      public:
         ...
         Boolean get_next (HashTable$(type)Iterator &it, T *&ptr) const;
         T *get_prev (HashTable$(type)Iterator &it) const;
         Boolean get_prev (HashTable$(type)Iterator &it, T *&ptr) const;
...
*/
template <class T> inline dmz::Boolean
dmz::HashTable$(type)Template<T>::get_next (
      HashTable$(type)Iterator &it,
      T *&ptr) const {
...
*/
template <class T> inline dmz::Boolean
dmz::HashTable$(type)Template<T>::get_prev (
      HashTable$(type)Iterator &it,
      T *&ptr) const {

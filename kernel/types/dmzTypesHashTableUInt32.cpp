...
\class dmz::HashTableUInt32Iterator
\ingroup Types
\brief Use to iterate over hash table elements.
\sa dmz::HashTableUInt32Template::get_first \n
dmz::HashTableUInt32Template::get_next \n
dmz::HashTableUInt32Template::get_prev \n
dmz::HashTableUInt32Template::get_last \n

*/

struct dmz::HashTableUInt32Iterator::idata {
...
//! Constructor.
dmz::HashTableUInt32Iterator::HashTableUInt32Iterator () : data (*(new idata)) {;}


//! Destructor.
dmz::HashTableUInt32Iterator::~HashTableUInt32Iterator () { delete &data; }


//! Gets hash key of current item returned from iteration.
dmz::UInt32
dmz::HashTableUInt32Iterator::get_hash_key () { return data.key; }


//! Resets iterator.
void
dmz::HashTableUInt32Iterator::reset () { data.index = -1; }


/*!

\class dmz::HashTableUInt32
\ingroup Types
\brief Internal class used by dmz::HashTableUInt32Template.
\note This Class should not be used directly. Use dmz::HashTableUInt32Template instead.

*/

struct dmz::HashTableUInt32::State {
   ...
   Boolean find_index (const UInt32 &Key, Int32 &index) const {
...
//! Constructor.
dmz::HashTableUInt32::HashTableUInt32 () : _state (*(new State ())) {;}


//! Constructor.
dmz::HashTableUInt32::HashTableUInt32 (
      const Int32 Size,
      const UInt32 Mask) :
      _state (*(new State ())) {
...
dmz::Int32
dmz::HashTableUInt32::get_size () const { return _state.size; }


//! Gets count of elements stored in hash table.
dmz::Int32
dmz::HashTableUInt32::get_count () const { return _state.count; }


//! Moves an element in the list.
dmz::Boolean
dmz::HashTableUInt32::move (
      const UInt32 &Key,
...
void *
dmz::HashTableUInt32::get_next (HashTableUInt32Iterator &it, const Boolean Prev) const {
...
void *
dmz::HashTableUInt32::lookup (const UInt32 &Key) const {
...
dmz::Boolean
dmz::HashTableUInt32::store (const UInt32 &Key, void *data) {
...
void *
dmz::HashTableUInt32::remove (const UInt32 &Key) {
...
void
dmz::HashTableUInt32::set_table_size (const Int32 Size) {
...
void
dmz::HashTableUInt32::set_attributes (const UInt32 Attributes) {
...
dmz::UInt32
dmz::HashTableUInt32::get_attributes () const {

...
\class dmz::HashTableUInt64Iterator
\ingroup Types
\brief Use to iterate over hash table elements.
\sa dmz::HashTableUInt64Template::get_first \n
dmz::HashTableUInt64Template::get_next \n
dmz::HashTableUInt64Template::get_prev \n
dmz::HashTableUInt64Template::get_last \n

*/

struct dmz::HashTableUInt64Iterator::idata {
...
//! Constructor.
dmz::HashTableUInt64Iterator::HashTableUInt64Iterator () : data (*(new idata)) {;}


//! Destructor.
dmz::HashTableUInt64Iterator::~HashTableUInt64Iterator () { delete &data; }


//! Gets hash key of current item returned from iteration.
dmz::UInt64
dmz::HashTableUInt64Iterator::get_hash_key () { return data.key; }


//! Resets iterator.
void
dmz::HashTableUInt64Iterator::reset () { data.index = -1; }


/*!

\class dmz::HashTableUInt64
\ingroup Types
\brief Internal class used by dmz::HashTableUInt64Template.
\note This Class should not be used directly. Use dmz::HashTableUInt64Template instead.

*/

struct dmz::HashTableUInt64::State {
   ...
   Boolean find_index (const UInt64 &Key, Int32 &index) const {
...
//! Constructor.
dmz::HashTableUInt64::HashTableUInt64 () : _state (*(new State ())) {;}


//! Constructor.
dmz::HashTableUInt64::HashTableUInt64 (
      const Int32 Size,
      const UInt32 Mask) :
      _state (*(new State ())) {
...
dmz::Int32
dmz::HashTableUInt64::get_size () const { return _state.size; }


//! Gets count of elements stored in hash table.
dmz::Int32
dmz::HashTableUInt64::get_count () const { return _state.count; }


//! Moves an element in the list.
dmz::Boolean
dmz::HashTableUInt64::move (
      const UInt64 &Key,
...
void *
dmz::HashTableUInt64::get_next (HashTableUInt64Iterator &it, const Boolean Prev) const {
...
void *
dmz::HashTableUInt64::lookup (const UInt64 &Key) const {
...
dmz::Boolean
dmz::HashTableUInt64::store (const UInt64 &Key, void *data) {
...
void *
dmz::HashTableUInt64::remove (const UInt64 &Key) {
...
void
dmz::HashTableUInt64::grow (const Int32 Size) {
...
void
dmz::HashTableUInt64::set_table_size (const Int32 Size) {
...
void
dmz::HashTableUInt64::set_attributes (const UInt32 Attributes) {
...
dmz::UInt32
dmz::HashTableUInt64::get_attributes () const {

...
\class dmz::HashTableUUIDIterator
\ingroup Types
\brief Use to iterate over hash table elements.
\sa dmz::HashTableUUIDTemplate::get_first \n
dmz::HashTableUUIDTemplate::get_next \n
dmz::HashTableUUIDTemplate::get_prev \n
dmz::HashTableUUIDTemplate::get_last \n

*/

struct dmz::HashTableUUIDIterator::idata {
...
//! Constructor.
dmz::HashTableUUIDIterator::HashTableUUIDIterator () : data (*(new idata)) {;}


//! Destructor.
dmz::HashTableUUIDIterator::~HashTableUUIDIterator () { delete &data; }


//! Gets hash key of current item returned from iteration.
dmz::UUID
dmz::HashTableUUIDIterator::get_hash_key () { return data.key; }


//! Resets iterator.
void
dmz::HashTableUUIDIterator::reset () { data.index = -1; }


/*!

\class dmz::HashTableUUID
\ingroup Types
\brief Internal class used by dmz::HashTableUUIDTemplate.
\note This Class should not be used directly. Use dmz::HashTableUUIDTemplate instead.

*/

struct dmz::HashTableUUID::State {
   ...
   Boolean find_index (const UUID &Key, Int32 &index) const {
...
//! Constructor.
dmz::HashTableUUID::HashTableUUID () : _state (*(new State ())) {;}


//! Constructor.
dmz::HashTableUUID::HashTableUUID (
      const Int32 Size,
      const UInt32 Mask) :
      _state (*(new State ())) {
...
dmz::Int32
dmz::HashTableUUID::get_size () const { return _state.size; }


//! Gets count of elements stored in hash table.
dmz::Int32
dmz::HashTableUUID::get_count () const { return _state.count; }


//! Moves an element in the list.
dmz::Boolean
dmz::HashTableUUID::move (
      const UUID &Key,
...
void *
dmz::HashTableUUID::get_next (HashTableUUIDIterator &it, const Boolean Prev) const {
...
void *
dmz::HashTableUUID::lookup (const UUID &Key) const {
...
dmz::Boolean
dmz::HashTableUUID::store (const UUID &Key, void *data) {
...
void *
dmz::HashTableUUID::remove (const UUID &Key) {
...
void
dmz::HashTableUUID::grow (const Int32 Size) {
...
void
dmz::HashTableUUID::set_table_size (const Int32 Size) {
...
void
dmz::HashTableUUID::set_attributes (const UInt32 Attributes) {
...
dmz::UInt32
dmz::HashTableUUID::get_attributes () const {

#ifndef DMZ_TYPES_HASH_TABLE_UUID_TEMPLATE_DOT_H
#define DMZ_TYPES_HASH_TABLE_UUID_TEMPLATE_DOT_H

#include <dmzTypesHashTableUUID.h>
...
\ingroup Types
\brief UUID hash table template.
\details Provides a template interface to the type unsafe dmz::HashTableUUID class.
The HashTableUUIDTemplate retains the order in which the elements are stored in the
...
*/
   template <class T> class HashTableUUIDTemplate {

      public:
         HashTableUUIDTemplate ();
         HashTableUUIDTemplate (const HashTableUUIDTemplate<T> &Table);
         HashTableUUIDTemplate (HashTableLock *lock);
         ...
         HashTableUUIDTemplate<T> &operator= (
            const HashTableUUIDTemplate<T> &Table);

         void copy (const HashTableUUIDTemplate<T> &Table);
         ...
         Boolean move_first (const UUID &Key);
         Boolean move_up (const UUID &Key);
         Boolean move_before (const UUID &Key, const UUID &TargetKey);
         Boolean move_after (const UUID &Key, const UUID &TargetKey);
         Boolean move_down (const UUID &Key);
         Boolean move_last (const UUID &Key);

         T *get_first (HashTableUUIDIterator &it) const;
         T *get_last (HashTableUUIDIterator &it) const;
         T *get_next (HashTableUUIDIterator &it) const;
         Boolean get_next (HashTableUUIDIterator &it, T *&ptr) const;
         T *get_prev (HashTableUUIDIterator &it) const;
         Boolean get_prev (HashTableUUIDIterator &it, T *&ptr) const;

         T *lookup (const UUID &Key) const;
         Boolean store (const UUID &Key, T *data);
         T *remove (const UUID &Key);
      ...
      private:
         ...
         HashTableUUID __table; //!< Internal state.
...
dmz::HashTableUUIDTemplate<T>::__lock () const {
...
template <class T> inline void
dmz::HashTableUUIDTemplate<T>::__unlock () const {
...
dmz::HashTableUUIDTemplate<T>::HashTableUUIDTemplate () : __tableLock (0) {;}
...
*/
template <class T> inline
dmz::HashTableUUIDTemplate<T>::HashTableUUIDTemplate (
      const HashTableUUIDTemplate<T> &Table) : __tableLock (0) { *this = Table; }
...
*/
template <class T> inline dmz::HashTableUUIDTemplate<T> &
dmz::HashTableUUIDTemplate<T>::operator= (const HashTableUUIDTemplate<T> &Table) {
...
constructor.
\param[in] Table HashTableUUID to be copied.

*/
template <class T> inline void
dmz::HashTableUUIDTemplate<T>::copy (const HashTableUUIDTemplate<T> &Table) {
...
*/
template <class T> inline void
dmz::HashTableUUIDTemplate<T>::clear () { __table.clear (); }
...
*/
template <class T> inline void
dmz::HashTableUUIDTemplate<T>::empty () {
...
dmz::HashTableUUIDTemplate<T>::get_size () const { return __table.get_size (); }


//! Gets number of elements stored in the table.
template <class T> inline dmz::Int32
dmz::HashTableUUIDTemplate<T>::get_count () const { return __table.get_count (); }


//! Moves element to the beginning of the list.
template <class T> inline dmz::Boolean
dmz::HashTableUUIDTemplate<T>::move_first (const UUID &Key) {
...
//! Moves element to the beginning of the list.
template <class T> inline dmz::Boolean
dmz::HashTableUUIDTemplate<T>::move_up (const UUID &Key) {
...
template <class T> inline dmz::Boolean
dmz::HashTableUUIDTemplate<T>::move_before (
      const UUID &Key,
...
template <class T> inline dmz::Boolean
dmz::HashTableUUIDTemplate<T>::move_after (
      const UUID &Key,
      const UUID &TargetKey) {
...
template <class T> inline dmz::Boolean
dmz::HashTableUUIDTemplate<T>::move_down (const UUID &Key) {
...
//! Moves element to the end of the list.
template <class T> inline dmz::Boolean
dmz::HashTableUUIDTemplate<T>::move_last (const UUID &Key) {
...
dmz::HashTableUUIDTemplate<T>::get_first (HashTableUUIDIterator &it) const {
...
*/
template <class T> inline T *
dmz::HashTableUUIDTemplate<T>::get_last (HashTableUUIDIterator &it) const {
...
*/
template <class T> inline T *
dmz::HashTableUUIDTemplate<T>::get_next (HashTableUUIDIterator &it) const {
...
*/
template <class T> inline dmz::Boolean
dmz::HashTableUUIDTemplate<T>::get_next (
      HashTableUUIDIterator &it,
      T *&ptr) const {
...
*/
template <class T> inline T *
dmz::HashTableUUIDTemplate<T>::get_prev (HashTableUUIDIterator &it) const {
...
*/
template <class T> inline dmz::Boolean
dmz::HashTableUUIDTemplate<T>::get_prev (
      HashTableUUIDIterator &it,
      T *&ptr) const {
...
*/
template <class T> inline T *
dmz::HashTableUUIDTemplate<T>::lookup (const UUID &Key) const {
...
*/
template <class T> inline dmz::Boolean
dmz::HashTableUUIDTemplate<T>::store (const UUID &Key, T *data) {
...
*/
template <class T> inline T *
dmz::HashTableUUIDTemplate<T>::remove (const UUID &Key) {
...
//! Sets the table lock.
template <class T> inline void
dmz::HashTableUUIDTemplate<T>::set_lock (HashTableLock *lock) {
